public class Main {
    ...
    public static void main(String[] args) {
        ...
        data = idScan(data);
        System.out.printf("%s\n", voteCounter(data, candidates, 0));
        System.out.printf("%s\n", voteCounter(data, candidates, 1));
        System.out.printf("%s\n", voteCounter(data, candidates, 2));
        System.out.printf("%s\n", voteCounter(data, candidates, 3));
    }
    ...
    public static String voteCounter(int[][] data, String[][] candidates, int office) {
        ...
        for (int i = 0; i < data[office].length; i++) {
            if (data[office][i] == 0) votes[0]++;
            if (data[office][i] == 1) votes[1]++;
            if (data[office][i] == 2) votes[2]++;
            if (data[office][i] == 3) votes[3]++;
            if (data[office][i] == 4) votes[4]++;
        }
